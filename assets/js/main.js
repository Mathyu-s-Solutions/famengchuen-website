...
/*==================== DARK LIGHT THEME ====================*/
const themeButton = document.getElementById("header-container");
...
themeButton.addEventListener("click", (event) => {
  // Verificar si el clic ocurrió en el botón del tema
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (membersContainer) {
    const wrapper = membersContainer.querySelector(".wrapper");
    const carousel = membersContainer.querySelector(".carousel");

    if (wrapper && carousel) {
      console.log("Cards Per View:");
